...
namespace HolidayApi.Migrations
{
    ...
    [Migration("20220213141632_ChangedHolidayAndHolidayNamesModels")]
    partial class ChangedHolidayAndHolidayNamesModels
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HolidayApi.Models.HolidayName", b =>
                {
                    ...
                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("HolidayNameId"), 1L, 1);
            ...
            modelBuilder.Entity("HolidayApi.Models.MaximumFreeDays", b =>
                {
                    b.Property<int>("MaximumFreeDaysId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("MaximumFreeDaysId"), 1L, 1);

                    b.Property<string>("Country")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<int>("MaximumFreeDaysResult")
                        .HasColumnType("int");

                    b.Property<int>("Year")
                        .HasColumnType("int");

                    b.HasKey("MaximumFreeDaysId");

                    b.ToTable("MaximumFreeDays");
                });
